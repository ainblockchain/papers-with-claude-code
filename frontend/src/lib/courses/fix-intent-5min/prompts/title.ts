...
- 제목이 이 케이스의 대상(위 [발견된 오분류 케이스] 의 현재 라벨 또는 유저 원문이 다루는 주제, 시험 결시/병결, 인텐트 분류/라벨 등) 또는 그 주변 맥락을 적어도 하나 언급하면 통과. 액션이 추상어("수정", "오류", "버그")여도 대상이 분명하면 OK.
- 예: "{현재 라벨} 오분류", "{현재 라벨} 수정", "결시 인텐트", "인텐트 오분류" 모두 통과.

[탈락]
- 단일 단어 또는 단일 추상어 (예: "오분류", "수정", "인텐트" 단독 입력, 또는 라벨명/주제어 단독 입력)
