...
const PUBLIC_PREFIX = ["/login", "/api/auth", "/api/courses", "/api/ain", "/api/knowledge", "/api/topics", "/api/explorations", "/api/frontier-map", "/api/x402", "/api/series", "/explore", "/agent-dashboard"]
